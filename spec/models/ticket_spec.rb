...
describe Ticket do
  ...
  describe "create our factories" do
  	before (:each) do
  		@match1= FactoryGirl.create(:match, :match_type=> "Europa League", :opponent_id=>2)
  		@match2=FactoryGirl.create(:match,:match_type =>"Friendly", :opponent_id =>1)
  		@opponent1=FactoryGirl.create(:opponent, :name=>"GOS",
  		:skill_level=>"Moderate",:home_capacity=>"5543",
  		:domestic=> true, :rival=>false)
  		...
  		@hawra=FactoryGirl.create(:fan,:name =>"Hawra", :email => "hai@hotmail.com")
  	end
